...
class CentralRNNAgent(nn.Module):
    ...
    def __init__(self, input_shape, args):
        ...
        ## prediction part
        self.pre_input = nn.Linear(args.pre_obs_shape, args.central_pre_hidden_dim)
        self.pre_fc1 = nn.Linear(args.central_pre_hidden_dim, args.central_pre_hidden_dim)
        self.pre_fc2 = nn.Linear(args.central_pre_hidden_dim, args.central_pre_hidden_dim)
        self.pre_fc3 = nn.Linear(args.central_pre_hidden_dim, args.central_pre_hidden_dim)
        self.pre_fc4 = nn.Linear(args.central_pre_hidden_dim, args.central_pre_hidden_dim)
        self.pre_output = nn.Linear(args.central_pre_hidden_dim, args.n_cards)
        ## main part
        self.main_input = nn.Linear(args.n_cards + input_shape, args.central_rnn_hidden_dim)
