...
from environment.bridge_utils import convert_id2rank, convert_id2suit
...
def solve_all(deals, strains, decalers):
    ...
    n_futp = _solve_all_boards(n, deals, strains, leaders, targets, sols, modes) ## number of the tricks won by the opponent group
